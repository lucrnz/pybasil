# AGENTS.md
This repository is a Python implementation of a VBScript parser and tree-walking interpreter, scoped as: VBScript 5.8 first, plus opt-in or non-conflicting VBA-compatible extensions and beyond.
